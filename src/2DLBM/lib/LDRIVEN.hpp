 ...
 *
 * The LDRIVEN class represents a two-dimensional model with nine discrete velocities (D2Q9)
 * for fluid dynamics simulation of a lid driven type problem based on the lattice Boltzmann approach.
 */
class LDRIVEN {
protected:
